...
module.exports = {
    run: async (message, args, client) => {
        ...
        message.channel.send(`***${message.author.username}*** a retiré le warn de **${member.user.tag.substring(0, member.user.tag.length-5)}** pour *${reason}* !`)
    },
    name : "unwarn",
    help: {
        description: "Permet de retirer un avertissement à un membre",
        systaxe: '<@membre> <avertissement>'
    },
    guildOnly : true
}